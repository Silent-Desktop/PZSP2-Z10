...
class TestPathBandwidthIOMatch:
    ...
    def test_mismatch_flow(self, constraint, population_factory, empty_inputs, sample_data):
        """
        ...
        # Path 0->2, edge 0 - 1
        usage[0, 0, 2, 0, 1] = 10.0
        
        # Path 0->2, edge 1 - 2
        usage[0, 0, 2, 1, 2] = 5.0 # Less outgoing than incoming
    ...
    def test_einsum_aggregation_complex(self, constraint, population_factory, empty_inputs):
        """
        ...
        # Path 0->3, edge 0 - 1
        usage[0, 0, 3, 0, 1] = 10.0
        # Path 0->3, edge 0 - 2
        usage[0, 0, 3, 0, 2] = 20.0
        
        # Path 0->3, edge 1 - 3
        usage[0, 0, 3, 1, 3] = 15.0
        usage[0, 0, 3, 2, 3] = 15.0
    ...
    def test_check_aggregation(self, constraint, population_factory, empty_inputs, sample_data):
        ...
        expected_score_p1 = 1.0 / (N * N) # Only one path has mismatch, rest are perfect
