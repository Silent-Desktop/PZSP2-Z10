import pytest
import torch
from net_opt.core.constraints.path_transponder_bandwidth_match import PathTransponderBandwidthMatch
...
class TestPathTransponderBandwidthMatch:
    ...
    def test_perfect_match(self, constraint, population_factory, empty_inputs, sample_data):
        """
        ...
        transponders[0, 0, 1, 0] = 60.0
        transponders[0, 0, 1, 1] = 40.0
        
        pop = population_factory(bandwidth_usage=usage, path_transponder_assignment=transponders)
        results = constraint._check_all(pop, **empty_inputs)
        
        assert results[0, 0, 1] == 0.0

    def test_mismatch_under_provisioned(self, constraint, population_factory, empty_inputs, sample_data):
        """
    ...
    def test_mismatch_over_provisioned(self, constraint, population_factory, empty_inputs, sample_data):
        """
