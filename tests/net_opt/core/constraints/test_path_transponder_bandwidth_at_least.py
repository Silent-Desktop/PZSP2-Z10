...
class TestPathTransponderBandwidthAtLeast:
    ...
    def test_compliant_bandwidth_exceeds_transponders(self, constraint, population_factory, empty_inputs, sample_data):
        """
    ...
    def test_compliant_exact_match(self, constraint, population_factory, empty_inputs, sample_data):
        """
    ...
    def test_violation_transponders_exceed_bandwidth(self, constraint, population_factory, empty_inputs, sample_data):
        """
