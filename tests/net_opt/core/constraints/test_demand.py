...
class TestDemand:
    ...
    def test_exact_match(self, constraint, population_factory, transponder_caps, sample_data):
        """
        ...
        # Pop 0, Path 0->1, Type 2 (100G) -> 1 unit
        transponders[0, 0, 1, 2] = 1.0 
    ...
    def test_over_provisioned(self, constraint, population_factory, transponder_caps, sample_data):
        """
    ...
    def test_under_provisioned(self, constraint, population_factory, transponder_caps, sample_data):
        """
    ...
    def test_zero_demand_zero_capacity(self, constraint, population_factory, transponder_caps, sample_data):
        """
    ...
    def test_check_aggregation_sums(self, constraint, population_factory, transponder_caps, sample_data):
        """
        ...
        # Pop 0: perfect match
        transponders[0, 0, 1, 2] = 1.0 
        transponders[0, 0, 2, 1] = 1.0
        transponders[0, 0, 2, 0] = 1.0
        
        # Pop 1: under-provisioned on both paths
        transponders[1, 0, 2, 1] = 1.0
        transponders[1, 0, 2, 0] = 1.0
